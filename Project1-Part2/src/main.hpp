...
extern float *hst_matrix1 = 0;
extern float *hst_matrix2 = 0;
extern float *hst_matrix3 = 0;
extern float *dev_matrix1 = 0;
extern float *dev_matrix2 = 0;
extern float *dev_matrix3 = 0;
